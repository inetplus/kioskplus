...
namespace kioskplus
{
    ...
    //    [MarshalAs(UnmanagedType.ByValArray, SizeConst = Win32Kernel.MAX_DEFAULTCHAR)]
    //    public byte[] DefaultChar;
    //    [MarshalAs(UnmanagedType.ByValArray, SizeConst = Win32Kernel.MAX_LEADBYTES)]
    ...
    //    public int dwReserved1;
    //    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Win32Kernel.MAX_PATH)]
    ...
    public abstract class AdvApi
    {
        ...
        [DllImport("advapi32")]
        public static extern int AdjustTokenPrivileges(IntPtr TokenHandle, bool DisableAllPrivileges, ref TOKEN_PRIVILEGES NewState, int BufferLength, IntPtr PreviousState, int ReturnLength);
        //[DllImport("advapi32")]
    ...
    //    [DllImport("kernel32")]
    //    public static extern int RegisterServiceProcess(int ProcesssID, uint flag);
    //    [DllImport("kernel32")]
