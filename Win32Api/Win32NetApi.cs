...
namespace kioskplus
{
    ...
    abstract class Win32NetApi
    {
        ...
        //public const int WN_ACCESS_DENIED = Win32Error.ERROR_ACCESS_DENIED;
        //public const int WN_ALREADY_CONNECTED = Win32Error.ERROR_ALREADY_ASSIGNED;
        //public const int WN_BAD_LOCALNAME = Win32Error.ERROR_BAD_DEVICE;
        //public const int WN_BAD_NETNAME = Win32Error.ERROR_BAD_NET_NAME;
        //public const int WN_BAD_PASSWORD = Win32Error.ERROR_INVALID_PASSWORD;
        //public const int WN_BAD_POINTER = Win32Error.ERROR_INVALID_ADDRESS;
        //public const int WN_BAD_PROFILE = Win32Error.ERROR_BAD_PROFILE;
        //public const int WN_BAD_PROVIDER = Win32Error.ERROR_BAD_PROVIDER;
        //public const int WN_BAD_USER = Win32Error.ERROR_BAD_USERNAME;
        //public const int WN_BAD_VALUE = Win32Error.ERROR_INVALID_PARAMETER;
        //public const int WN_CANNOT_OPEN_PROFILE = Win32Error.ERROR_CANNOT_OPEN_PROFILE;
        //public const int WN_CONNECTION_CLOSED = Win32Error.ERROR_CONNECTION_UNAVAIL;
        //public const int WN_DEVICE_ERROR = Win32Error.ERROR_GEN_FAILURE;
        //public const int WN_DEVICE_IN_USE = Win32Error.ERROR_DEVICE_IN_USE;
        //public const int WN_EXTENDED_ERROR = Win32Error.ERROR_EXTENDED_ERROR;
        //public const int WN_FUNCTION_BUSY = Win32Error.ERROR_BUSY;
        //public const int WN_MORE_DATA = Win32Error.ERROR_MORE_DATA;
        //public const int WN_NET_ERROR = Win32Error.ERROR_UNEXP_NET_ERR;
        //public const int WN_NOT_CONNECTED = Win32Error.ERROR_NOT_CONNECTED;
        //public const int WN_NOT_SUPPORTED = Win32Error.ERROR_NOT_SUPPORTED;
        //public const int WN_NO_NETWORK = Win32Error.ERROR_NO_NETWORK;
        //public const int WN_NO_NET_OR_BAD_PATH = Win32Error.ERROR_NO_NET_OR_BAD_PATH;
        //public const int WN_OPEN_FILES = Win32Error.ERROR_OPEN_FILES;
        //public const int WN_OUT_OF_MEMORY = Win32Error.ERROR_NOT_ENOUGH_MEMORY;
        //public const int WN_SUCCESS = Win32Error.NO_ERROR;
        //public const int WN_WINDOWS_ERROR = Win32Error.ERROR_UNEXP_NET_ERR;
    }
}
